...
def main(argv):
    #default_file = '../9. perspective/perspective_dark.jpg'
    default_file = '../8. ROI & hough/images/perspective.jpg'
    ...
    ## [edge_detection]
    # Edge detection
    blur = cv.GaussianBlur(src, (3, 3), 2)
    filter = cv.bilateralFilter(src, 9, 75, 75)
